...
if(isset($_POST["btn_web"]))
{
  ...
  if($_FILES['logo']['name']!=''){
   ...
   $q1="UPDATE `manage_website` SET `business_name`='$business_name',`business_email`='$business_email',`business_web`='$business_web',`portal_addr`='$portal_addr' ,`addr`= '$addr', `logo` = '$file_name'";
